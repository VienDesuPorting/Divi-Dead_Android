...
extern size_t RING_RW_read(SDL_RWops *rw, void *ptr, size_t size, size_t maxnum);
extern size_t RING_RW_write(SDL_RWops *rw, const void *ptr, size_t size, size_t maxnum);
extern Sint64 RING_RW_seek(SDL_RWops *rw, Sint64 offset, int whence);
